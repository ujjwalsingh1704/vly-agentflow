      ...
      <div className="w-full space-y-6">
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full">
          {[
            ...
            >
              <Card className="h-full w-full border-border/50 bg-card/50 p-5 backdrop-blur-sm">
                <div className={`mb-3 flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br ${stat.color}`}>
                  <TrendingUp className="h-4 w-4 text-white" />
                </div>
                <p className="mb-1.5 text-xs font-medium text-muted-foreground">{stat.label}</p>
                <div className="flex items-baseline justify-between">
                  <span className="text-2xl font-bold">{stat.value}</span>
                  <Badge variant="default" className="h-5 bg-green-500/10 px-1.5 text-xs font-medium text-green-600">
                    {stat.change}
                  </Badge>
                </div>
              </Card>
        ...
        <motion.div
          ...
          className="px-1"
        >
          <Card className="border-border/50 bg-card/50 p-5 backdrop-blur-sm sm:p-6">
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-1">Lead Conversion Trends</h3>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Card className="h-full p-6 border-border/50 bg-card/50 backdrop-blur-sm flex flex-col">
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-1">Voice Agent Success Metrics</h3>
          ...
          >
            <Card className="h-full p-6 border-border/50 bg-card/50 backdrop-blur-sm flex flex-col">
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-1">Chatbot Engagement Metrics</h3>
