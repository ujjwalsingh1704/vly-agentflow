...
const VoiceAgent = () => {
  ...
  const handleStartCall = async () => {
    try {
      ...
      // Trigger n8n webhook
      const response = await fetch("https://ujjwalsingh1703.app.n8n.cloud/webhook-test/voice-agent-trigger", {
        method: "POST",
        headers: {
  ...
  const stats = [
    { label: "Active Time", value: isCallActive ? `${Math.floor(callDuration / 60)}:${String(callDuration % 60).padStart(2, '0')}` : "0:00" },
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">AI-powered voice calling interface</p>
          </div>
          <Badge variant={isCallActive ? "default" : "outline"} className={isCallActive ? "bg-green-500/10 text-green-600 border-green-500/20 animate-pulse" : ""}>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          >
            <Card className="overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
              <div className="p-6 border-b border-border/50 bg-gradient-primary/5">
              ...
              <div className="p-6 bg-background/50">
                <iframe
                  ...
                  className="w-full h-[60vh] rounded-2xl shadow-xl border border-border/50"
                ...
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 p-3 rounded-xl hover:bg-muted/50 transition-colors">
                    ...
                    <Badge 
                      variant="outline"
                      className={
                        call.outcome === "Qualified" ? "bg-green-500/10 text-green-600 border-green-500/20" :
                        call.outcome === "Follow-up" ? "bg-orange-500/10 text-orange-600 border-orange-500/20" :
